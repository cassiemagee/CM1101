...
def list_of_items(items):
    ...
    lastitems = ""
    for ch in items:
        newitems.append(ch["name"])
        lastitems = ", ".join(newitems)
    return lastitems
...
def print_room_items(rooms):
    ...
    #print(rooms["items"]+ "\n")
    #for ch in rooms["name"]:
    item_list = list_of_items(rooms["items"])
    if len(item_list) > 0:
            print("There is " + str(item_list) + " here." + "\n")
   # print("There is a " + str(list_of_items(rooms["items"])) + " here.")

       # print(list_of_items(items["name"]))
...
def print_inventory_items(items):
    ...
    item_list1 = list_of_items(items)
    if len(item_list1) > 0:
        print("You have " + str(item_list1) +"." +"\n")
...
def print_menu(exits, room_items, inv_items):
    ...
    for _items in room_items:
        print("TAKE " + _items["id"].upper() + " to take " + _items["name"] + ".")
    for _drop in inv_items:
        print("DROP " + _drop["id"].upper() + " to drop " + _drop["name"] + ".")
